 ...
 */
final class Version20230106102605 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company (id INT AUTO_INCREMENT NOT NULL, sector_id INT NOT NULL, industry_id INT NOT NULL, symbol VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, beta NUMERIC(10, 2) NOT NULL, last_div NUMERIC(10, 2) NOT NULL, cik VARCHAR(255) NOT NULL, website VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, ceo VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, full_time_employees INT NOT NULL, phone VARCHAR(255) DEFAULT NULL, address VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, state VARCHAR(255) DEFAULT NULL, zip VARCHAR(255) NOT NULL, dcf_diff NUMERIC(10, 2) DEFAULT NULL, dcf NUMERIC(10, 2) DEFAULT NULL, image_url VARCHAR(255) NOT NULL, avatar VARCHAR(255) DEFAULT NULL, ipo_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_4FBF094FECC836F9 (symbol), INDEX IDX_4FBF094FDE95C867 (sector_id), INDEX IDX_4FBF094F2B19A734 (industry_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
